...
from bibbi.constants import TYPE_GEOGRAPHIC, TYPE_TOPIC, TYPE_CORPORATION, TYPE_PERSON
from test.util import make_datarow
        ...
        (
            ...
            },
            {
                'original': {
                    ...
                    'nn': 'Bartholomeus I, 1940-, tyrk. : økumenisk patriark av Konstantinopel, 1940-'
                },
                'transformed': {
                    'nb': 'Bartholomeus I',
                    'nn': 'Bartholomeus I'
